...
public interface TableModel{
     ...
     * @see #setValueAt()
     */
    function isCellEditable(rowIndex:int, columnIndex:int):Boolean;
     ...
     */
    function getValueAt(rowIndex:int, columnIndex:int):*;
     ...
     * @see #isCellEditable()
     */
    function setValueAt(aValue:*, rowIndex:int, columnIndex:int):void;
