...
public interface BoundedRangeModel{
     ...
     */
	function setValue(newValue:int, programmatic:Boolean=true):void;
     ...
     */
	function setValueIsAdjusting(b:Boolean):void;
     ...
     */
	function getValueIsAdjusting():Boolean;
     ...
     * @see org.aswing.event.InteractiveEvent#isProgrammatic()
     */
	function setRangeProperties(value:int, extent:int, min:int, max:int, adjusting:Boolean, programmatic:Boolean=true):void;
