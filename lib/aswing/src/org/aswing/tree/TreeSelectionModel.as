...
public interface TreeSelectionModel{
    ...
    /**
      ...
      */
    function setSelectionPath(path:TreePath, programmatic:Boolean=true):void;
    ...
    /**
      ...
      * @param programmatic indicate if this is a programmatic change.
      */
    function setSelectionPaths(paths:Array, programmatic:Boolean=true):void;
    ...
    /**
      ...
      * @param programmatic indicate if this is a programmatic change.
      */
    function addSelectionPath(path:TreePath, programmatic:Boolean=true):void;
    ...
    /**
      ...
      * @param programmatic indicate if this is a programmatic change.
      */
    function addSelectionPaths(paths:Array, programmatic:Boolean=true):void;
    ...
    /**
      ...
      * @param programmatic indicate if this is a programmatic change.
      */
    function removeSelectionPath(path:TreePath, programmatic:Boolean=true):void;
    ...
    /**
      ...
      * @param programmatic indicate if this is a programmatic change.
      */
    function removeSelectionPaths(paths:Array, programmatic:Boolean=true):void;
    ...
    /**
      ...
      */
    function getSelectionPaths():Array;
    ...
    /**
      ...
      * selection.
      */
    function isPathSelected(path:TreePath):Boolean;
    ...
    /**
      ...
      */
    function getSelectionRows():Array;
    ...
    /**
      ...
      */
    function isRowSelected(row:int):Boolean;
    ...
    /**
      ...
      */
    function addTreeSelectionListener(listener:Function, priority:int=0, useWeakReference:Boolean=false):void;
    
	/**
	 * Removed a treeSelectionListener.
	 * @param listener the listener to be removed.
	 */    
    function removeTreeSelectionListener(listener:Function):void;
}
}