...
public class FixedHeightLayoutCache extends AbstractLayoutCache{
	 ...
	 * @see #rootVisible
	 */
	override public function setRootVisible(rootVisible:Boolean):void {
	...
	/**
	  ...
	  */
	override public function isExpanded(path:TreePath):Boolean {
		if(path != null) {
	...
	private function getVisibleFHTreeStateNodes(parent:FHTreeStateNode, startIndex:int, totalCount:int):Array{
	 ...
	 */
	override public function setExpandedState(path:TreePath, isExpanded:Boolean):void {
		if(isExpanded){
	 ...
	 */
	override public function getExpandedState(path:TreePath):Boolean {
		var node:FHTreeStateNode = getNodeForPath(path, true, false);
	...
	override public function treeNodesRemoved(e:TreeModelEvent):void {
		if(e != null) {
			...
			for(var counter:int = maxCounter - 1; counter >= 0; counter--) {
